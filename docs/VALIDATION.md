...
Evidence: user-provided Azure Databricks screenshots from September 10, 2026. The successful advanced run lasted approximately 15 minutes 45 seconds. Original run screenshots are included in images/. They contain resource names and run/job identifiers; they do not provide authentication credentials.
